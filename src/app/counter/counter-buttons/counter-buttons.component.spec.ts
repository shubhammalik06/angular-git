...
import { customChannelName, customIncrement, decrement, increment, reset } from '../state/counter.actions';
...
describe('Store Tests', () => {
  ...
  it('Check the custom increment value', () => {
    const newState = counterReducer(initialState, customIncrement({ value: 20 }));
